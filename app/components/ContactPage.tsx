                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <a href="#" className="text-white/60 hover:text-white transition-colors text-sm font-medium">Twitter / X</a>
                      <span className="text-white/20">•</span>
                      <a href="#" className="text-white/60 hover:text-white transition-colors text-sm font-medium">Instagram</a>
                    </div>
                  </div>
                </div>
              </div>
